...
/**
 * VkrController implements the CRUD actions for Vkr model.
 */
class VkrController extends Controller
{
    ...
    /**
     * Lists all Vkr models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new VkrSearch();
    ...
    /**
     * Finds the Vkr model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Vkr the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Vkr::findOne($id)) !== null) {
            return $model;
        }
